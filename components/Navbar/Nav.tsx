...
const Navbar = () => {
  ...
  return (
    <nav
      className=" flex justify-between items-center pr-5 lg:px-10 fixed top-0 py-3 md:py-2 z-5 bg-[#7556FB] w-screen overflow-x-hidden z-50"
      ref={menuRef}
    >
      <motion.div
        initial={{ opacity: 0 }}
        ...
        className={holt.className}
        ref={logoRef}
      >
        <Image
          src={logo}
          alt="mymoma-logo"
          className="lg:h-[75px] h-[60px] object-contain"
        />
      </motion.div>
      {!isHam && (
        <div
